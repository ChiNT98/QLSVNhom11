...
namespace QUANLYSINHVIEN.Areas.Mod.Controllers
{
    public class DiemThisController : Controller
    {
        ...
        // GET: Mod/DiemThis/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Mod/DiemThis/Create
