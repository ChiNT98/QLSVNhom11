...
namespace QUANLYSINHVIEN.Areas.Admin.Controllers
{
    public class GiangViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaGv,TenGv,MaKhoa,MaLop")] GiangVien giangVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaGv,TenGv,MaKhoa,MaLop")] GiangVien giangVien)
        {
            if (ModelState.IsValid)
            {
